    ...
    <div className="p-6 bg-white rounded-2xl shadow-md">
      <div className="flex gap-5 items-center">
        <div className="relative">
          ...
          />
          <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-[#2AC9AF] to-[#4B79D9] rounded-full p-1.5">
      ...
      <div className="space-y-6">
        <div>
          ...
          <Progress
            ...
            indicatorClassName="bg-gradient-to-r from-[#2AC9AF] to-[#4B79D9]"
          />
        </div>
          ...
          <div
            className={`px-4 py-1.5 rounded-full text-sm font-medium ${
              userData?.subscriptionId
                ? "bg-gradient-to-r from-[#2AC9AF]/20 to-[#4B79D9]/20 text-blue-700"
        ...
        <div className="mt-8 p-6 border-2 border-blue-100 rounded-2xl bg-gradient-to-r from-blue-50 to-green-50">
          ...
          <Button className="w-full bg-gradient-to-r from-[#2AC9AF] to-[#4B79D9] hover:opacity-90 text-white rounded-full py-6 shadow-md hover:shadow-lg transition-all">
